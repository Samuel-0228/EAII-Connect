        ...
        <div className="space-y-8">
          <div className="grid sm:grid-cols-3 gap-6">
            <div className="bg-[#00885a] p-6 rounded-3xl text-white">
              ...
              <p className="text-sm opacity-80 uppercase font-bold tracking-widest">{lang === 'en' ? 'Active Courses' : 'ትምህርቶች'}</p>
            </div>
            <div className="bg-white p-6 rounded-3xl border border-slate-200">
              <Award size={32} className="mb-4 text-[#fcd116]" />
              <p className="text-4xl font-bold mb-1 text-slate-900">12</p>
              <p className="text-sm text-slate-500 uppercase font-bold tracking-widest">{lang === 'en' ? 'Certificates' : 'የምስክር ወረቀቶች'}</p>
            </div>
          </div>
           ...
           <div className="grid lg:grid-cols-3 gap-6">
              <div className="lg:col-span-2 bg-white p-6 rounded-3xl border border-slate-200">
                <h3 className="font-bold text-slate-900 mb-6 flex items-center">
                  <BarChart className="mr-2 text-[#00885a]" size={20} /> Overview
                </h3>
