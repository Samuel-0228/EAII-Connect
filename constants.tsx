...
export const TRANSLATIONS: Record<string, any> = {
  en: {
    ...
    voiceDescHint: "Describe the image or text in your own voice.",
    submit: "Submit Contribution",
    loginToTrack: "Login to track your contributions",
    selam: "Selam",
  ...
  am: {
    ...
    voiceDesc: "የድምፅ መግለጫ",
    voiceDescHint: "ምስሉን ወይም ጽሑፉን በራስዎ ድምጽ ይግለጹ።",
    submit: "ተሳትፎን ይላኩ",
    loginToTrack: "ተሳትፎዎን ለመከታተል ይግቡ",
    selam: "ሰላም",
  ...
  om: {
    ...
    voiceDescHint: "Fakkicha ykn barreeffamicha sagalee keessaniin ibsaa.",
    submit: "Gumaacha Ergaa",
    loginToTrack: "Gumaacha keessan hordofuuf seenaa",
    selam: "Selam",
